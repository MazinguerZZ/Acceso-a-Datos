...
ALTER TABLE Empleado ADD CONSTRAINT FOREIGN KEY FK_Empelado (jefeID) REFERENCES Empleado(nDIEmp);
...
ALTER TABLE Departamento ADD CONSTRAINT FOREIGN KEY FK_Director (codDirector) REFERENCES Empleado(nDIEmp);
ALTER TABLE Empleado ADD CONSTRAINT FOREIGN KEY FK_Departamento (codDepto) REFERENCES Departamento(codDepto);

INSERT INTO Departamento (codDepto, nombreDpto, ciudad ) VALUES
('1000', 'GERENCIA', 'CALI'),
...
('16.759.060', 'Darío Casas', 'M', '1960-04-05', '1992-11-01', 4500000, 500000, 'Investigador', '31.840.269', '3000'),('22.222.222', 'Carla López', 'F', '1975-05-11', '2005-07-16', 4500000, 500000,
'Jefe Mercadeo', '31.840.269', '3500'), ('22.222.333', 'Carlos Rozo', 'M', '1975-05-11', '2001-09-16', 750000, 500000,
'Vigilante', '31.840.269', '3500') ,
...
UPDATE Departamento SET codDirector = '31.840.269' WHERE codDepto = '1000';
UPDATE Departamento SET codDirector = '16.211.383' WHERE codDepto = '1500';
UPDATE Departamento SET codDirector = '31.178.144' WHERE codDepto = '2000';
UPDATE Departamento SET codDirector = '16.759.060' WHERE codDepto = '3000';
UPDATE Departamento SET codDirector = '22.222.222' WHERE codDepto = '3500';
UPDATE Departamento SET codDirector = '1.751.219' WHERE codDepto = '2100';
UPDATE Departamento SET codDirector = '768.782' WHERE codDepto = '2200';
UPDATE Departamento SET codDirector = '737.689' WHERE codDepto = '2300';
UPDATE Departamento SET codDirector = '333.333.333' WHERE codDepto = '4000';
UPDATE Departamento SET codDirector = '888.888' WHERE codDepto = '4100';
UPDATE Departamento SET codDirector = '11.111.111' WHERE codDepto = '4200';
UPDATE Departamento SET codDirector = '444.444' WHERE codDepto = '4300';