...
public class Utilidades {
	...
	private static final String PROPERTIES_FILE="Tema3/tema3/transparencias/mysql-properties.xml";
	...
	private void setProperties(String fileName) throws IOException, InvalidPropertiesFormatException {
		...
		this.serverTimezone = this.prop.getProperty("server_timezone");

		/* Para no tener tantos mensajes por pantalla los comentamos
	...
	public Connection getConnection() throws SQLException {
		...
		connectionProps.put("serverTimezone", this.serverTimezone);
